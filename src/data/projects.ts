...
export const projectsData: Project[] = [
  {
    ...
    media: [
      ...
      },
      {
        ...
        src: "/projects/Spotify_Project.pbix",
      },
    ],
  ...
  },
  {
    ...
    media: [
      ...
      },
      {
        ...
        type: "file",
        label: "Download PBIX file",
        src: "/projects/zomato_dasborad.pbix",
      },
    ],
  ...
  {
    id: "p3",
    title: "Shopify E-commerce Sales Analysis",
    category: "Data Analytics",
    summary:
      "An interactive Shopify e-commerce sales analytics dashboard providing actionable insights into e-commerce performance and customer behavior.",
    description:
      "A comprehensive analysis of transactional Shopify e-commerce data featuring custom KPIs, dynamic visualizations, and drill-down reports to uncover sales trends, product performance, customer segments, and regional revenue patterns, enabling data-driven business decisions.",
    stack: ["Power BI", "DAX", "Python", "SQL"],
    year: "2026",
    links: {
      live: "/project/p3",
    ...
    media: [
      {
        ...
        label: "Project screenshot",
        src: "/projects/sample-image.svg",
        alt: "Shopify E-commerce Sales Analysis screenshot",
      },
      {
        id: "p3-video",
        type: "video",
      ...
      },
      {
        ...
        type: "file",
        label: "Download PBIX file",
        src: "/projects/Shopify_project.pbix",
      },
    ],
  ...
  },
  {
    ...
    media: [
      ...
      },
      {
        ...
        type: "file",
        label: "Download PBIX file",
        src: "/projects/phonepe-data-analysis-powerbi.pbix",
      },
    ],
  ...
  {
    id: "p5",
    title: "Walmart Superstore Sales Analysis & Dashboard",
    category: "Data Analytics",
    summary: "An interactive sales analytics dashboard providing actionable insights into Walmart superstore performance and customer behavior.",
    description:
      "A comprehensive analysis of Walmart superstore transactional data featuring custom KPIs, dynamic visualizations, and drill-down reports to uncover sales trends, product performance, customer segments, and regional revenue patterns, enabling data-driven business decisions.",
    stack: ["Power BI", "DAX", "Python", "SQL"],
    year: "2026",
    links: {
      live: "/project/p5",
    ...
    media: [
      {
        ...
        label: "Project screenshot",
        src: "/projects/sample-image.svg",
        alt: "Walmart Superstore Sales Analysis screenshot",
      },
      {
        id: "p5-video",
        type: "video",
      ...
      },
      {
        ...
        type: "file",
        label: "Download PBIX file",
        src: "/projects/WALMART%20SALES%20US%20DATASET.pbix",
      },
    ],
  ...
  },
  {
    ...
    media: [
      ...
      },
      {
        ...
        type: "file",
        label: "Download PBIX file",
        src: "/projects/Airbnb%20Performance%20Dashboard.pbix",
      },
    ],
  ...
  },
  {
    ...
    media: [
      ...
      },
      {
        ...
        type: "file",
        label: "Download PBIX file",
        src: "/projects/Healthcare%20Power%20BI.pbix",
      },
    ],
    accent: "from-amber-500/20 to-obsidian-700/30",
